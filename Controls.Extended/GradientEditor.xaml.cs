...
namespace Imagin.Controls.Extended
{
    public partial class GradientEditor : UserControl
    {
        ...
        public static DependencyProperty AngleProperty = DependencyProperty.Register("Angle", typeof(double), typeof(GradientEditor), new PropertyMetadata(0d, OnAngleChanged));
        public double Angle
        {
            get
            {
        ...
        {
            ((GradientEditor)Object).OnAngleChanged((double)e.NewValue);
        }

        public static DependencyProperty AngularUnitProperty = DependencyProperty.Register("AngularUnit", typeof(AngularUnit), typeof(GradientEditor), new PropertyMetadata(AngularUnit.Degree));
        ...
        public static DependencyProperty GradientProperty = DependencyProperty.Register("Gradient", typeof(Brush), typeof(GradientEditor), new PropertyMetadata(default(Brush), OnGradientChanged, new CoerceValueCallback(OnGradientCoerced)));
        ...
        {
            ((GradientEditor)d).OnGradientChanged((Brush)e.NewValue);
        }
        static object OnGradientCoerced(DependencyObject d, object value)
        {
            return ((GradientEditor)d).OnGradientCoerced(value);
        }
        
        public static DependencyProperty GradientPositionProperty = DependencyProperty.Register("GradientPosition", typeof(GradientPosition), typeof(GradientEditor), new PropertyMetadata(GradientPosition.Start, OnGradientPositionChanged));
        ...
        {
            ((GradientEditor)Object).OnGradientPositionChanged((GradientPosition)e.NewValue);
        }
        
        public static DependencyProperty GradientTypeProperty = DependencyProperty.Register("GradientType", typeof(GradientType), typeof(GradientEditor), new PropertyMetadata(GradientType.Linear, OnGradientTypeChanged));
        ...
        {
            ((GradientEditor)Object).OnGradientTypeChanged((GradientType)e.NewValue);
        }
        ...
        public static DependencyProperty RadiansProperty = DependencyProperty.Register("Radians", typeof(double), typeof(GradientEditor), new PropertyMetadata(0d));
        ...
        public static DependencyProperty ShowPreviewProperty = DependencyProperty.Register("ShowPreview", typeof(bool), typeof(GradientEditor), new PropertyMetadata(true));
