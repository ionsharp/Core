...
namespace Imagin.Controls.Extended
{
    ...
    public sealed class RepeatOptionsPropertyModel : PropertyModel
    {
        protected override object OnPreviewValueChanged(object NewValue)
        {
            return NewValue == null ? new RepeatOptions(Recurrence.None) : (RepeatOptions)NewValue;
        }
    ...
    public sealed class SolidColorBrushPropertyModel : PropertyModel
    {
        protected override object OnPreviewValueChanged(object NewValue)
        {
            return NewValue == null ? default(SolidColorBrush) : (SolidColorBrush)(new BrushConverter().ConvertFrom(NewValue));
        }
