...
namespace Imagin.Controls.Common
{
    ...
    public abstract class PropertyGridBase : System.Windows.Controls.UserControl
    {
        #region Fields
        ...
        /// 
        /// </summary>
        public static DependencyProperty ListCollectionViewProperty = DependencyProperty.Register("ListCollectionView", typeof(ListCollectionView), typeof(PropertyGridBase), new FrameworkPropertyMetadata(default(ListCollectionView)));
        /// <summary>
        /// 
        /// </summary>
        ...
        protected virtual void OnLanguageChanged(object sender, EventArgs<CultureInfo> e)
        {
            ...
            {
                var localizedCategory = Localizer.GetValue<string>(i.Category);
        ...
        {
            SetCurrentValue(ListCollectionViewProperty, new ListCollectionView(value));
        }
