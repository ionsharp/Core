...
namespace Imagin.Controls.Common
{
    ...
    public class LabModel : ColorSpaceModel<Lab>
    {
        ...
        public sealed class LComponent : SelectableComponentModel
        {
            ...
            {
                var c = new Lab(Color);
                return new Lab(NewComponentValue.ToDouble(), c.A, c.B).Color;
            }
        ...
        public sealed class AComponent : SelectableComponentModel
        {
            ...
            {
                var c = new Lab(Color);
                return new Lab(c.L, NewComponentValue.ToDouble(), c.B).Color;
            }
        ...
        public sealed class BComponent : SelectableComponentModel
        {
            ...
            {
                var c = new Lab(Color);
                return new Lab(c.L, c.A, NewComponentValue.ToDouble()).Color;
            }
