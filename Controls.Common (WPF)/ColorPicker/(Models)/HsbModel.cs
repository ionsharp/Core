...
namespace Imagin.Controls.Common
{
    ...
    public class HsbModel : ColorSpaceModel<Hsb>
    {
        ...
        public sealed class HComponent : SelectableComponentModel
        {
            ...
            {
                var c = new Hsb(Color);
                return new Hsb(NewComponentValue.ToDouble(), c.S, c.B).Color;
            }
        ...
        public sealed class SComponent : SelectableComponentModel
        {
            ...
            {
                var c = new Hsb(Color);
                return new Hsb(c.H, NewComponentValue.ToDouble(), c.B).Color;
            }
        ...
        public sealed class BComponent : SelectableComponentModel
        {
            ...
            {
                var c = new Hsb(Color);
                return new Hsb(c.H, c.S, NewComponentValue.ToDouble()).Color;
            }
