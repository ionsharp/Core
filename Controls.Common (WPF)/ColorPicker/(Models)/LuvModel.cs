...
namespace Imagin.Controls.Common
{
    ...
    public class LuvModel : ColorSpaceModel<Luv>
    {
        ...
        public sealed class LComponent : SelectableComponentModel
        {
            ...
            {
                var c = new Luv(Color);
                return new Luv(NewComponentValue.ToDouble(), c.U, c.V).Color;
            }
        ...
        public sealed class UComponent : SelectableComponentModel
        {
            ...
            {
                var c = new Luv(Color);
                return new Luv(c.L, NewComponentValue.ToDouble(), c.V).Color;
            }
        ...
        public sealed class VComponent : SelectableComponentModel
        {
            ...
            {
                var c = new Luv(Color);
                return new Luv(c.L, c.U, NewComponentValue.ToDouble()).Color;
            }
