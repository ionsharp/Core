...
namespace Imagin.Controls.Common
{
    ...
    public abstract class UpDown<T> : UpDown, IUpDown<T>
    {
        ...
        /// 
        /// </summary>
        public sealed override void RiseValue()
        {
            SetCurrentValue(ValueProperty.Property, Maximum);
        }

        /// <summary>
        /// 
        /// </summary>
        public sealed override void SinkValue()
        {
            SetCurrentValue(ValueProperty.Property, Minimum);
        }
