namespace Imagin.Common.Configuration
{
    ...
    #region public static class SingleInstance<TApplication>
    ...
    /// </remarks>
    public static class SingleInstance<TApplication> where TApplication : Application, ISingleApplication
    {
        #region Classes
        ...
        class IPCRemoteService : MarshalByRefObject
        {
            ...
            public void InvokeFirstInstance(IList<string> args)
            {
                ...
                if (Application.Current != null)
                    _ = Dispatch.InvokeAsync(DispatcherPriority.Normal, new DispatcherOperationCallback(SingleInstance<TApplication>.ActivateFirstInstanceCallback), args);
            }
        ...
        static void CreateRemoteService(string channelName)
        {
            ...
            IPCRemoteService remoteService = new();
        ...
        {
            IpcClientChannel secondInstanceChannel = new();
        ...
        static void ActivateFirstInstance(IList<string> args)
        {
            ...
            ((TApplication)Application.Current).OnReopened(args);
        }
