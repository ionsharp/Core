...
namespace Imagin.Common.Configuration
{
    public enum AssemblySource
    {
        ...
        Calling,
        /// <summary>
        /// The process executable in the default application domain. In other application domains, this is the first executable that was executed by <see cref="AppDomain.ExecuteAssembly(string)"/>.
        /// </summary>
        Entry,
        /// <summary>
