...
namespace Imagin.Common.Local.Engine
{
    ...
    public class EnumComboBox : ComboBox
    {
        ...
        /// The Type.
        /// </summary>
        public static readonly DependencyProperty TypeProperty = DependencyProperty.Register("Type", typeof(Type), typeof(EnumComboBox), new FrameworkPropertyMetadata(TypeChanged));
        ...
        /// </summary>
        public static readonly DependencyProperty PrependTypeProperty = DependencyProperty.Register("PrependType", typeof(bool), typeof(EnumComboBox), new FrameworkPropertyMetadata(false));
        ...
        /// The Separator.
        /// </summary>
        public static readonly DependencyProperty SeparatorProperty = DependencyProperty.Register("Separator", typeof(string), typeof(EnumComboBox), new FrameworkPropertyMetadata("_"));
        ...
        /// The Prefix.
        /// </summary>
        public static readonly DependencyProperty PrefixProperty = DependencyProperty.Register("Prefix", typeof(string), typeof(EnumComboBox), new FrameworkPropertyMetadata(null));
