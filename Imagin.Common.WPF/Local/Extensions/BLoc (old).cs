...
namespace Imagin.Common.Globalization.Extensions
{
    /// <summary>
    ...
    public class BLoc : Binding, INotifyPropertyChanged, IDictionaryEventListener, IDisposable
    {
        ...
        */
        ...
        void UpdateNewValue() => Value = FormatOutput();

        /// <summary>
        /// Forced culture handling: If Culture property defines a valid <see cref="CultureInfo"/>, a <see cref="CultureInfo"/> instance will get
        ...
        /// <summary>
        /// This function returns the properly prepared output of the markup extension (future TargetMarkupExtension implementation).
        /// </summary>
        public object FormatOutput()
        {
            ...
            if (result == null)
            {
                ...
                if (result == null)
                {
                    ...
                    if (LocalizeDictionary.Instance.OutputMissingKeys && !string.IsNullOrEmpty(_key))
                    {
                        result = missingKeyEventResult.MissingKeyResult != null 
