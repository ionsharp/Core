...
namespace Imagin.Common.Media.Animation
{
    static class AnimationCache
    {
        ...
        private static readonly Dictionary<CacheKey, AnimationCacheEntry> _animationCache = new();
        private static readonly Dictionary<CacheKey, HashSet<Image>> _imageControls = new();
