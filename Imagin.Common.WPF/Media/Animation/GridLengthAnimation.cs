...
namespace Imagin.Common.Media.Animation
{
    ...
    public class GridLengthAnimation : AnimationTimeline
    {
        ...
        /// </summary>
        public static readonly DependencyProperty ReverseValueProperty = DependencyProperty.Register("ReverseValue", typeof(double), typeof(GridLengthAnimation), new FrameworkPropertyMetadata(0.0));
