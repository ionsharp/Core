...
namespace Imagin.Common.Collections.Concurrent
{
    ...
    internal class DispatcherQueueProcessor
    {
        ...
        /// </summary>
        static readonly Lazy<DispatcherQueueProcessor> _instance = new(() => new DispatcherQueueProcessor(), true);
        readonly object ActionWaitingLock = new();
        readonly object StartQueueLock = new();
        ...
        /// </summary>
        readonly Semaphore ActionWaitingSemaphore = new(0, 1);
