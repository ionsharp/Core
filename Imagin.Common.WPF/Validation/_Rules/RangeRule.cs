...
namespace Imagin.Common
{
    ...
    public abstract class RangeRule<TValue> : NamedRule
    {
        ...
        /// </summary>
        /// <returns></returns>
        protected ValidationResult ValidateMax() => new ValidationResult(false, Name + " must be <= " + Max + ".");

        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        protected ValidationResult ValidateMin() => new ValidationResult(false, Name + " must be >= " + Min + ".");
