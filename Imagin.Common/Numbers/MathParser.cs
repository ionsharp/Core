...
namespace Imagin.Common.Numbers
{
    ...
    {
        char Operator(MathParserDifficulty difficulty)
        {
            var n = 4;
            switch (difficulty)
            {
                //+, -
                case MathParserDifficulty.Easy:
                    n = 2;
                    break;
                //+, -, *
                case MathParserDifficulty.Normal:
                    n = 3;
                    break;
                //+, -, *, /
                case MathParserDifficulty.Hard:
                    n = 4;
                    break;
            }
        ...
        public string Create(MathParserDifficulty difficulty)
        {
        ...
        public double Solve(string equation)
        {
            ...
            return Convert.ToDouble(dataTable.Compute(equation, string.Empty));
        }
    }
    ...
    public class AdvancedMathParser
    {
        ...
        {
            {"pi", NumberMaker + Numbers.PI.ToString() },
            {"e", NumberMaker + Numbers.E.ToString() }
        };
        ...
        public AdvancedMathParser(char decimalSeparator)
        {
        ...
        private double ApplyTrigFunction(Func<double, double> func, double arg)
        {
            if (!isRadians)
            {
                arg = arg * Numbers.PI / 180; // Convert value to degree
            }
