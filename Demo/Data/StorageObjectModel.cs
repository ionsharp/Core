...
{
    public class StorageObjectModel : NamedObject
    {
                ...
                if (value)
                {
                    ...
                    try
                    {
                        foreach (var i in System.IO.Directory.EnumerateFileSystemEntries(Path))
                            Items.Add(new StorageObjectModel(i));
                    }
                    catch
                    {
                        //Do nothing!
        ...
        ObservableCollection<StorageObjectModel> items = new ObservableCollection<StorageObjectModel>();
        public ObservableCollection<StorageObjectModel> Items
        {
            get
            {
                return this.items;
        ...
        public StorageObjectModel() : base("New File System Entry")
        {
        }

        public StorageObjectModel(string path) : base()
        {
            Path = path;
            Set(path);
        }
