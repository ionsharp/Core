...
/// <summary>Specifies an <see cref="object"/> that implements <see cref="IDisposable"/>.</summary>
[Serializable]
public abstract class Disposable : Base, IDisposable
{
    bool disposed = false;

    public Disposable() : base() { }
