...
namespace Imagin.Colour.Adaptation
{
    ...
    public static class LMSTransformationMatrix
    {
        ...
        /// </summary>
        public static readonly Matrix Bradford = new[]
        {
        ...
        /// </summary>
        public static readonly Matrix BradfordSharp = new[]
        {
        ...
        /// </summary>
        public static readonly Matrix CMCCAT2000 = new[]
        {
            new[] {  0.7982, 0.3389, -0.1371 },
            new[] { -0.5918, 1.5512,  0.0406 },
            new[] {  0.0008, 0.2390,  0.9753 },
        };

        /// <summary>
        /// CAT02 (optimized for minimizing CIELAB differences)
        /// </summary>
        public static readonly Matrix CAT02 = new[]
        {
        ...
        /// </summary>
        public static readonly Matrix VonKriesHPE = new[]
        {
            new[] {  0.3897, 0.6890, -0.0787 },
            new[] { -0.2298, 1.1834,  0.0464 },
            new[] {  0.0000, 0.0000,  1.0000 },
        };

        /// <summary>
        /// Von Kries chromatic adaptation transform matrix (Hunt-Pointer-Estevez adjusted for D65)
        /// </summary>
        public static readonly Matrix VonKriesHPEAdjusted = new[]
        {
            new[] {  0.40024, 0.70760, -0.08081 },
            new[] { -0.2263,  1.16532,  0.04570 },
            new[] {  0.0000,  0.00000,  0.91822 },
        };

        /// <summary>
        /// XYZ scaling chromatic adaptation transform matrix
        /// </summary>
        public static readonly Matrix XYZScaling = Matrix.Identity(3);
    }
}
