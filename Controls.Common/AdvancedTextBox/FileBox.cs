...
namespace Imagin.Controls.Common
{
    ...
    public class FileBox : AdvancedTextBox
    {
        ...
        {
            string[] Paths;
            if (DialogProvider.Show(out Paths, "Browse...", this.Type == FileSystemEntry.Folder ? DialogProviderType.FolderBrowser : DialogProviderType.OpenFile, DialogProviderMode.Single, null, this.Text))
                this.Text = Paths[0];
        }
