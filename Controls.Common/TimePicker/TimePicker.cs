...
namespace Imagin.Controls.Common
{
    ...
    {
        const string PART_TimeListItems = "PART_TimeListItems";

        #region Properties

        ListBox _timeListBox;

        bool _isListBoxInvalid = true;
        ...
        static object OnCoerceEndTime(DependencyObject o, object value)
        {
        ...
        static void OnEndTimeChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            TimePicker timePicker = o as TimePicker;
            if (timePicker != null)
        ...
        static void OnMaxDropDownHeightChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            TimePicker timePicker = o as TimePicker;
            if (timePicker != null)
        ...
        static object OnCoerceStartTime(DependencyObject o, object value)
        {
            TimePicker timePicker = o as TimePicker;
            if (timePicker != null)
        ...
        static void OnStartTimeChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            TimePicker timePicker = o as TimePicker;
            if (timePicker != null)
        ...
        static object OnCoerceTimeInterval(DependencyObject o, object value)
        {
            TimePicker timePicker = o as TimePicker;
            if (timePicker != null)
        ...
        static void OnTimeIntervalChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            TimePicker timePicker = o as TimePicker;
            if (timePicker != null)
        ...
        #region TimeItemStyle

        public static DependencyProperty TimeItemStyleProperty = DependencyProperty.Register("TimeItemStyle", typeof(Style), typeof(TimePicker), new FrameworkPropertyMetadata(default(Style), FrameworkPropertyMetadataOptions.BindsTwoWayByDefault));
        public Style TimeItemStyle
        {
            get
            {
                return (Style)GetValue(TimeItemStyleProperty);
            }
            set
            {
                SetValue(TimeItemStyleProperty, value);
            }
        }
        ...
        TimeItem GetNearestTimeItem(TimeSpan time)
        {
            if (_timeListBox != null)
            {
        ...
        void TimeListBox_MouseUp(object sender, MouseButtonEventArgs e)
        {
            ClosePopup(true);
        }
        ...
        protected override void OnValueChanged(DateTime? oldValue, DateTime? newValue)
        {
            ...
            if (this.Minimum.IsEqualTo(oldValue)
            != this.Minimum.IsEqualTo(newValue))
            {
                invalidate = true;
            }

            if (this.Maximum.IsEqualTo(oldValue)
            != this.Maximum.IsEqualTo(newValue))
            {
                invalidate = true;
            }
