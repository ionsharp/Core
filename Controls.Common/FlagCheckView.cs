...
namespace Imagin.Controls.Common
{
    ...
    public class FlagCheckView : UserControl
    {
        ...
        /// 
        /// </summary>
        public static DependencyProperty ItemsProperty = DependencyProperty.Register("Items", typeof(TrackableCollection<CheckableObject<object>>), typeof(FlagCheckView), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault));
        /// <summary>
        /// 
        /// </summary>
        public TrackableCollection<CheckableObject<object>> Items
        {
            get
            {
                return (TrackableCollection<CheckableObject<object>>)GetValue(ItemsProperty);
            }
            protected set
            {
        ...
        public FlagCheckView() : base()
        {
            ...
            Items = new TrackableCollection<CheckableObject<object>>();
            ...
            if (!FlagsChangeHandled)
            {
                ...
                if (OldValue?.GetType() != NewValue?.GetType())
                {
                    ...
                    if (NewValue != null && NewValue.GetType().IsEnum)
                        NewValue.GetType().GetEnumValues().Where(i => !i.HasAttribute<BrowsableAttribute>() || i.GetAttribute<BrowsableAttribute>().Browsable).ForEach(i => Items.Add(new CheckableObject<object>(i, Flags.To<Enum>().Has(i as Enum))));
                }
