...
namespace Imagin.Common
{
    ...
    internal sealed class DragSelector : Imagin.Common.ObjectBase
    {
        #region Properties
        ...
        DragSelector(ItemsControl itemsControl) : base()
        {
            ...
            var selection = new DragSelection();
            selection.Bind(DragSelection.SelectionProperty, new Binding()
            {
