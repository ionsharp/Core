...
public class BinarySerializer
{
    public static Result Deserialize<T>(string filePath, out T data)
    {
        ...
        {
            result = (Error)new DeserializationFailedException(data?.GetType() ?? typeof(object), e);
    ...
    public static Result Serialize(string filePath, object data)
    {
        ...
        {
            result = (Error)new SerializationFailedException(data?.GetType() ?? typeof(object), e);
            Log.Write<BinarySerializer>(result);
        }
        finally
        {
